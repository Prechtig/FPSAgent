...
//		File networkFile = FileSystemDAO.getPathOfLatestModelFile().toFile();
		File networkFile = Paths.get("models", "light-deep", "model4.bin").toFile();
		
		MultiThreadedBridge server = new MultiThreadedBridge(networkFile);
